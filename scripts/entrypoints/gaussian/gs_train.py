...
from gaussian_splatting.gaussian_renderer import network_gui, render
                ...
                progress_bar.set_postfix(
                    {
                        ...
                        "L1 Loss": f"{Ll1.item():.{5}f}",
                        "Depth Loss": f"{loss_depth.item():.{5}f}",
                        "Normal Loss": f"{loss_normal.item():.{5}f}",
                        "Seg Loss": f"{loss_seg.item():.{5}f}",
                        "Anisotropic Loss": f"{loss_anisotropic.item():.{5}f}",
                    }
                )
